...
(function (global) {
  ...
  var COLS = 9;
  /* 48: dashboard stack viz+products+branding+notify+quick+asana (2x2 floor 8). */
  var MAX_ROWS = 48;
  /* v8: media 2x2 floor 8 so viz/products never share a row before measure. */
  ...
  var DEFAULT_MIN_SIZES = {
    ...
    quick_links: { w: 3, h: 4 },
    newest_viz_3: { w: 9, h: 8 },
    newest_products_f: { w: 9, h: 8 },
    branding_latest: { w: 9, h: 8 },
    asana_home: { w: 6, h: 8 },
  ...
  function mediaTileLayoutMinH(layout) {
    /* Floors must cover 2x2 packshots. Tiny floors (4) let height:auto
     * paint into the next widget before measure/images. */
    if (layout === "1x6") return 14;
    if (layout === "1x4") return 10;
    return 8;
  }
