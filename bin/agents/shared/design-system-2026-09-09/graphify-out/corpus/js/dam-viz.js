...
(function () {
  ...
  function fetchVizIndexFromBridge() {
    ...
    return fetch(url, opts)
      ...
      .then(function (text) {
        if (window.DamSearch && typeof window.DamSearch.parseJsonInWorker === "function") {
          return window.DamSearch.parseJsonInWorker(text, "viz-latest", 20000);
        }
  ...
  function init() {
    ...
    function loadIndex() {
      ...
      return fetchVizIndexFromBridge().finally(function () {
