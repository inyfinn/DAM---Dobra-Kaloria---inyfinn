...
- `bin/instalator/DAM-Setup.exe`: 78670359 B przed relokacja 2026-09-15, FileVersion/ProductVersion 6.0.0. Plik jest w `.gitignore` (nie w gicie).
...
- `bin/instalator/PLAN-INSTALATOR.md` (ten plik) nie byl w `0526d70` - do commita parenta.
