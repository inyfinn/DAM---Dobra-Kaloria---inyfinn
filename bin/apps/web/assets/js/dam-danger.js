...
(function (global) {
  ...
  function ensureCss() {
    ...
    var css = [
      ...
      "background:transparent;color:var(--dam-primary,#005A29);",
      "border:1px solid color-mix(in srgb,var(--dam-primary,#005A29) 35%,#ececf2);",
      "border-radius:8px;padding:8px 14px;min-height:40px;font-size:13px;font-weight:700;cursor:pointer;",
      "transition:background .14s ease,border-color .14s ease;}",
      ".dam-danger-toast__undo:hover{background:color-mix(in srgb,var(--dam-primary,#005A29) 10%,#fff);",
      "border-color:var(--dam-primary,#005A29);}",
      ".dam-danger-toast__undo:focus-visible{outline:2px solid var(--dam-primary,#005A29);outline-offset:2px;}",
