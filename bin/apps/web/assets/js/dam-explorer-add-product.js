...
(function (global) {
  ...
  function injectCss() {
    ...
    var css =
      ...
      both(" .dam-exp-create__tree-row i") + "{color:var(--dam-primary);font-size:15px}" +
      ...
      both(" .dam-exp-create__subcombo-opt.is-selected") + "{background:color-mix(in srgb,var(--dam-primary,#005A29) 8%,transparent)}" +
